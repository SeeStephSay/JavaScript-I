...
// inventory.filter( item => console.log(inventory[32]));

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.

// for (let lastCar = 0; lastCar < inventory.length; lastCar++) {
//   if (lastCar == inventory.length - 1) {
//     return `The last car is a ${inventory.car_make} ${inventory.car_model}.`;
//   }
// }
// console.log(lastCar);

let lastCar = inventory[inventory.length - 1];
let lastCarInfo = lastCar.car_make + " " + lastCar.car_model;
console.log(lastCarInfo);

// let lastCar = [];
// for (let i = 0; i < inventory.length; i++) {
//   if (i == inventory.length - 1) {
//     return lastCar.push(inventory[i]);
//   }
// }
// console.log(lastCar);
...
let BMWAndAudi = [];
let niceCars = inventory.filter(car => car.car_make === "BMW" || car.car_make === "Audi");
console.log(JSON.stringify(niceCars));
console.log(niceCars.length);
